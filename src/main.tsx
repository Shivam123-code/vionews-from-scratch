...
// Only in the Lovable editor preview (*.lovableproject.com), direct cross-origin
// requests to Supabase fail. Rewrite them through the Vite dev-server proxy.
// On production (vionews.in, etc.) direct requests to Supabase work fine — no shim needed.
