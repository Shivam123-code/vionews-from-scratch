    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-12 max-w-3xl">
        ...
        <div className="prose prose-lg max-w-none space-y-6 text-foreground/90">
          ...
          <p>We may use third-party services for analytics, advertising, and content delivery. These services may collect information about your browsing activity across different websites. We recommend reviewing the privacy policies of these third-party providers.</p>
