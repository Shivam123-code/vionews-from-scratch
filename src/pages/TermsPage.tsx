...
export default function TermsPage() {
  useDocumentMeta({
    title: "Terms of Service | VioNews",
    description: "Review the VioNews terms of service. By using vionews.in you agree to these terms governing content use, user conduct, and liability.",
    canonical: "https://vionews.in/terms-of-service",
  });
    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="container py-12 max-w-3xl">
        ...
        <div className="prose prose-lg max-w-none space-y-6 text-foreground/90">
          ...
          <p>By accessing and using VioNews (vionews.in), you agree to be bound by these Terms of Service.</p>
          <h2 className="text-2xl font-bold">2. Use of Content</h2>
          <p>All content on VioNews, including articles, images, and graphics, is protected by copyright. You may read and share articles for personal, non-commercial purposes. Reproduction or redistribution without written permission is prohibited.</p>
